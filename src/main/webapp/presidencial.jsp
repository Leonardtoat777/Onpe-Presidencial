                    ...
                    <div class="col-xs-12 col-md-3">
                        <div class="menu-interna">
                            <ul>
                                ...
                                <li><a href="SvlPresidencial?id=">RESULTADOS PRESIDENCIALES</a></li>
                                <li><a href="SvlPresidencial?id=">RESULTADOS POR TIPO DE VOTOS</a></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div id="page-wrap">
								    <table class="table01">
                                        <tbody>
											...
											<tr>
												<td><img width="40px" height="40px" src="images/simbolo_ppk.jpg" class="spaceimg"><img width="40px" height="40px" src="images/keyko.jpg" class="spaceimg">PERUANOS POR EL KAMBIO </td>
													<td><%=data[0] %></td>
													<td><%=data[2] %></td> 
																										
											</tr>
											<tr>
											<td><img width="40px" height="40px" src="images/simbolo_keyko.jpg" class="spaceimg"><img width="40px" height="40px" src="images/pkk.jpg" class="spaceimg">FUERZA POPULAR </td>
													<td><%=data[1] %></td>
													<td><%=data[3] %></td> 																											
											</tr>
										</tbody>
